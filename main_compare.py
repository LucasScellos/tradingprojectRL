...
tesla_data = tg.recuperation_donnee(
    name="tsla", start="01/01/2017", end="01/04/2022", interval="1d"
)
google_data = tg.recuperation_donnee(
    name="goog", start="01/01/2017", end="01/04/2022", interval="1d"
)
...
########## Test PPO sur tesla ###################
env_PPO, info_PPO = tg.evaluation(
    df=tesla_data, model=model_PPO, frame_bound=(1000, 1200)
)
tg.graphique(env_PPO, "PPO-tesla")

########## Test PPO sur google ###################
env_PPO, info_PPO = tg.evaluation(
    df=google_data, model=model_PPO, frame_bound=(1000, 1200)
)
